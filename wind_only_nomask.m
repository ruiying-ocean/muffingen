...
%
par_wor_name='wortdofy';       % ['STRING'] 8-char (output) config name
par_gcm='hadcm3l';             % ['STRING'] input format/GCM name
par_expid='tdofy';             % ['STRING'] input experiment/data name
%
% *** FILE PATHS ******************************************************** %
%
...
par_A_frac_threshold=0.0;     % [0.0-1.0] land fractional area threshold  
...
%
opt_makemask=false;             % [false/true] re-grid mask?
opt_maketopo=false;             % [false/true] re-grid bathymetry?
